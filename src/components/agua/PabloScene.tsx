...
export function PabloScene() {
  ...
  return (
    <div className="relative flex flex-row-reverse items-end gap-0.5 select-none" style={{ touchAction: 'manipulation' }}>
      ...
      {balloon && (
        <div
          className="absolute z-20 right-0 top-full mt-1 flex items-center gap-2 px-3 py-2 rounded-2xl"
          style={{
      ...
      >
        {st.state === 'locked' ? (
          <span className="relative group block" style={{ width: 'min(13vmin, 50px)', aspectRatio: '614 / 406' }}>
            ...
            <span
              className="absolute z-20 right-0 top-full mt-1 px-2.5 py-1 rounded-full text-xs font-black whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity"
      ...
      {confirmUnlock && (
        <>
          ...
          <div
            className="absolute z-50 right-0 top-full mt-2 flex flex-col items-stretch gap-2 p-2.5 rounded-2xl text-center"
